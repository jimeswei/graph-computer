...
docker run -itd --name=graph --network ci -p 18080:8080 hugegraph/hugegraph:"${GRAPH_ENV_VERSION}" && sleep 6
...
docker exec -i loader bin/hugegraph-loader.sh -g hugegraph -p 18080 -h graph \
